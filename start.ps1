##################################################################################
# This is the Testing script that will install nodejs and all the dependencies   #
# for the Project. Be careful when you are using this script.                    #
##################################################################################
# this Scrit will run the Porject on Windows 
Write-Host("This is the start script for the Portfolio Website");
